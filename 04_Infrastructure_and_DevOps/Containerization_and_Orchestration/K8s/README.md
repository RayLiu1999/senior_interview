...
| 15 | [Service Data Plane 與 EndpointSlice](./kubernetes_service_data_plane_and_endpointslice.md) | 7 | 5 | `Kubernetes`, `Service`, `EndpointSlice`, `kube-proxy` |
| 16 | [DNS 與 Service Discovery](./kubernetes_dns_and_service_discovery.md) | 6 | 5 | `Kubernetes`, `DNS`, `CoreDNS`, `Service Discovery` |
...
6.  **沿著流量路徑學習**: 依序掌握 Pod 網路、Service／EndpointSlice、DNS、Ingress／Gateway 與 NetworkPolicy，並用 endpoint、route、policy 和封包證據排查問題。
